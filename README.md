...
```scala
libraryDependencies += "com.malliina" %% "primitives" % "3.7.2"
```
...
```scala
libraryDependencies += "com.malliina" %% "okclient" % "3.7.2"
```
...
```scala
libraryDependencies += "com.malliina" %% "okclient-io" % "3.7.2"
```
...
```scala
libraryDependencies += "com.malliina" %% "config" % "3.7.2"
```
