...
```scala
libraryDependencies += "com.malliina" %% "primitives" % "6.11.1"
```
...
```scala
libraryDependencies += "com.malliina" %% "okclient" % "6.11.1"
```
...
```scala
libraryDependencies += "com.malliina" %% "okclient-io" % "6.11.1"
```
...
```scala
libraryDependencies += "com.malliina" %% "config" % "6.11.1"
```
