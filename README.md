...
```scala
libraryDependencies += "com.malliina" %% "primitives" % "6.12.0"
```
...
```scala
libraryDependencies += "com.malliina" %% "okclient" % "6.12.0"
```
...
```scala
libraryDependencies += "com.malliina" %% "okclient-io" % "6.12.0"
```
...
```scala
libraryDependencies += "com.malliina" %% "config" % "6.12.0"
```
