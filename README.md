...
```scala
libraryDependencies += "com.malliina" %% "primitives" % "3.8.3"
```
...
```scala
libraryDependencies += "com.malliina" %% "okclient" % "3.8.3"
```
...
```scala
libraryDependencies += "com.malliina" %% "okclient-io" % "3.8.3"
```
...
```scala
libraryDependencies += "com.malliina" %% "config" % "3.8.3"
```
