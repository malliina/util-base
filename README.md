...
```scala
libraryDependencies += "com.malliina" %% "primitives" % "6.13.0"
```
...
```scala
libraryDependencies += "com.malliina" %% "okclient" % "6.13.0"
```
...
```scala
libraryDependencies += "com.malliina" %% "okclient-io" % "6.13.0"
```
...
```scala
libraryDependencies += "com.malliina" %% "config" % "6.13.0"
```
