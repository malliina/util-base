...
```scala
libraryDependencies += "com.malliina" %% "primitives" % "6.14.1"
```
...
```scala
libraryDependencies += "com.malliina" %% "okclient" % "6.14.1"
```
...
```scala
libraryDependencies += "com.malliina" %% "okclient-io" % "6.14.1"
```
...
```scala
libraryDependencies += "com.malliina" %% "config" % "6.14.1"
```
