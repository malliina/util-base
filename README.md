...
```scala
libraryDependencies += "com.malliina" %% "primitives" % "6.10.3"
```
...
```scala
libraryDependencies += "com.malliina" %% "okclient" % "6.10.3"
```
...
```scala
libraryDependencies += "com.malliina" %% "okclient-io" % "6.10.3"
```
...
```scala
libraryDependencies += "com.malliina" %% "config" % "6.10.3"
```
