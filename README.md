...
```scala
libraryDependencies += "com.malliina" %% "primitives" % "3.5.1"
```
...
```scala
libraryDependencies += "com.malliina" %% "okclient" % "3.5.1"
```
...
```scala
libraryDependencies += "com.malliina" %% "okclient-io" % "3.5.1"
```
...
```scala
libraryDependencies += "com.malliina" %% "config" % "3.5.1"
```
