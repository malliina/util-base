...
```scala
libraryDependencies += "com.malliina" %% "primitives" % "6.10.4"
```
...
```scala
libraryDependencies += "com.malliina" %% "okclient" % "6.10.4"
```
...
```scala
libraryDependencies += "com.malliina" %% "okclient-io" % "6.10.4"
```
...
```scala
libraryDependencies += "com.malliina" %% "config" % "6.10.4"
```
