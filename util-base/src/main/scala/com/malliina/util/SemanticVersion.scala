...
case class SemanticVersion(version: String):
  ...
  def !=(other: SemanticVersion): Boolean = !(this == other)

  def <(other: SemanticVersion): Boolean = major < other.major ||
    (major == other.major && minor < other.minor) ||
    (major == other.major && minor == other.minor && patch < other.patch) ||
    (major == other.major && minor == other.minor && patch == other.patch && isPrerelease && !other.isPrerelease)

  def <=(other: SemanticVersion): Boolean = this == other || this < other
...
object SemanticVersion:
  def parse(version: String): Either[NumberFormatException, SemanticVersion] =
    try Right(SemanticVersion(version))
    catch case nfe: NumberFormatException => Left(nfe)
