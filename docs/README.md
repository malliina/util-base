...
```scala
libraryDependencies += "com.malliina" %% "primitives" % "@VERSION@"
```
...
```scala
libraryDependencies += "com.malliina" %% "okclient" % "@VERSION@"
```
...
```scala
libraryDependencies += "com.malliina" %% "okclient-io" % "@VERSION@"
```
...
```scala
libraryDependencies += "com.malliina" %% "config" % "@VERSION@"
```
